...
class User(UserMixin, db.Model):
    ...
    flight_id = db.Column(db.String(10))
    flight_origin = db.Column(db.String(60))
    airline = db.Column(db.String(60))
    flight_destination = db.Column(db.String(60))
    flight_date = db.Column(db.String(60))
